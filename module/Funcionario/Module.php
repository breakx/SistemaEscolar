<?php
/**
 * namespace para nosso modulo funcionarios
 */
namespace Funcionario;

// import Funcionario\Model
use Funcionario\Model\Funcionario,
    Funcionario\Model\FuncionarioTable;
...
class Module
{
    ...
    public function getViewHelperConfig()
    {
        return array(
            ...
            'invokables' => array(
                'filter_funcionario' => 'Funcionario\View\Helper\FuncionarioFilter'
            )
        );
    }
        ...
        return array(
            'factories' => array(
                'FuncionarioTableGateway' => function ($sm) {
                    ...
                    // configurar ResultSet com nosso model Funcionario
                    $resultSetPrototype = new ResultSet();
                    $resultSetPrototype->setArrayObjectPrototype(new Funcionario());

                    // return TableGateway configurado para nosso model Funcionario
                    return new TableGateway('funcionarios', $adapter, null, $resultSetPrototype);
                },
                'ModelFuncionario' => function ($sm) {
                    // return instacia Model FuncionarioTable
                    return new FuncionarioTable($sm->get('FuncionarioTableGateway'));
                },
            )
        );
    }
